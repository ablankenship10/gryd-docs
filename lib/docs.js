...
exports.errors = function (status, code, reason) {
  if(arguments.length == 3)
    return {status: arguments[0], code: arguments[1], reason: arguments[2]};
  else
  return {status: arguments[0], reason: arguments[1]};
};
